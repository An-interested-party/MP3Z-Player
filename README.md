...
transfer to your phone and open it with a package installer (it should pop up automatically as an option when you try to open the apk file)
...
the IOS filing system works, and that you'd need only change 5 blocks to get it to work ( I highly encourage you to try :] ) .


What I'm talking about here is when you pick to open a folder, you are using the storage access framework, the android will
...
Anyway yeah thats really all it is, you could easily change this if you want to, I'll link my MIT app inventor link
...
-->  I did this in case you want to have specific playlists to choose from like a workout remix or a study playlist (yurwelcom). 
...
their playlist without needing to plug two phones together, or enjoy having an end of the year music rewind, that's ok.
